...
(isset($context["attribute"]) || array_key_exists("attribute", $context) ? $context["attribute"] : (function () { throw new Twig_Error_Runtime('Variable "attribute" does not exist.', 323, $this->source); })()), "type", array()) == "string")) {
                ...
                echo "</td>
                    ...
                    <tr class=\"voter_details\">
                        ...
                        ";
                // line 337
                if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, $context["decision"], "voter_details", array()))) {
                    // line 338
                    echo "                            ";
                    $context["voter_details_id"] = ("voter-details-" . twig_get_attribute($this->env, $this->source, $context["loop"], "index", array()));
                    // line 339
                    echo "                            <div id=\"";
                    ...
                    // line 342
                    $context['_parent'] = $context;
                    $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["decision"], "voter_details", array()));
                    foreach ($context['_seq'] as $context["_key"] => $context["voter_detail"]) {
                        // line 343
                        echo "                                        <tr>
                                            <td class=\"font-normal\">";
                        // line 344
                        echo $this->extensions['Symfony\Bundle\WebProfilerBundle\Twig\WebProfilerExtension']->dumpData($this->env, twig_get_attribute($this->env, $this->source, $context["voter_detail"], "class", array(), "array"));
                        echo "</td>
                                            ";
                        // line 345
                        if ((twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new Twig_Error_Runtime('Variable "collector" does not exist.', 345, $this->source); })()), "voterStrategy", array()) == twig_constant("Symfony\\Component\\Security\\Core\\Authorization\\AccessDecisionManager::STRATEGY_UNANIMOUS"))) {
                            // line 346
                            echo "                                            <td class=\"font-normal text-small\">attribute ";
                            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["voter_detail"], "attributes", array(), "array"), 0, array(), "array"), "html", null, true);
                            echo "</td>
                                            ";
                        }
                        // line 348
                        echo "                                            <td class=\"font-normal text-small\">
                                                ";
                        // line 349
                        if ((twig_get_attribute($this->env, $this->source, $context["voter_detail"], "vote", array(), "array") == twig_constant("Symfony\\Component\\Security\\Core\\Authorization\\Voter\\VoterInterface::ACCESS_GRANTED"))) {
                            // line 350
                            echo "                                                    ACCESS GRANTED
                                                ";
                        } elseif ((twig_get_attribute($this->env, $this->source,                         // line 351
$context["voter_detail"], "vote", array(), "array") == twig_constant("Symfony\\Component\\Security\\Core\\Authorization\\Voter\\VoterInterface::ACCESS_ABSTAIN"))) {
                            // line 352
                            echo "                                                    ACCESS ABSTAIN
                                                ";
                        } elseif ((twig_get_attribute($this->env, $this->source,                         // line 353
$context["voter_detail"], "vote", array(), "array") == twig_constant("Symfony\\Component\\Security\\Core\\Authorization\\Voter\\VoterInterface::ACCESS_DENIED"))) {
                            // line 354
                            echo "                                                    ACCESS DENIED
                                                ";
                        } else {
                            // line 356
                            echo "                                                    unknown (";
                            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["voter_detail"], "vote", array(), "array"), "html", null, true);
                            echo ")
                                                ";
                        }
                        // line 358
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@Security/Collector/security.html.twig", "/home/wilfried/Documents/CMS_et_framework/my_project/vendor/symfony/security-bundle/Resources/views/Collector/security.html.twig");
    }
}
