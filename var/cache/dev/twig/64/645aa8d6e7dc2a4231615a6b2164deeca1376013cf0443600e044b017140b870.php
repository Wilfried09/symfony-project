...
";
    ...
    ";
        ...
        <div id=\"twig-dump\">
            ";
            // line 112
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new Twig_Error_Runtime('Variable "collector" does not exist.', 112, $this->source); })()), "htmlcallgraph", array()), "html", null, true);
            echo "
        </div>
    ";
        }
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/twig.html.twig", "/home/wilfried/Documents/CMS_et_framework/my_project/vendor/symfony/web-profiler-bundle/Resources/views/Collector/twig.html.twig");
    }
}
